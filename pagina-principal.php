...
<body>
	<?php 
		include 'menus/header-principal.html';
	 ?>
...
<br>
  ...
  <div class="tab-content">
    <div id="productos" class="tab-pane fade in active">
      <br>
       <?php include 'categorias/productos.php'; ?>
    </div>
    <div id="Libros" class="tab-pane fade">
      <br>
       <?php include 'categorias/libros.php'; ?>
    </div>
    <div id="Papeleria" class="tab-pane fade">
      <br>
      <?php include 'categorias/Papeleria.php'; ?>
    </div>
    <div id="Estudiantes" class="tab-pane fade">
      <br>
     <?php include 'categorias/Estudiantes.php'; ?>
    </div>
    <div id="Oficina" class="tab-pane fade">
      <br>
      <?php include 'categorias/Oficina.php'; ?>
    </div>
